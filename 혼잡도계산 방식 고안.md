...
![[스크린샷 2023-11-08 오후 3.45.55.png]]Z.Zivkovic의 2004년 논문(Improved adaptive Gausian mixture model for background subtraction)과 2006년 논문(Efficient Adaptive Density Estimation per Image Pixel for the Task of Background Subtraction) 참고

OpenCV를 이용하여 배경을 제거한 후, 특정한 영역을 설정하고 해당 영역을 통과하는 경우나 ROI 라인을 통과하는 경우 카운팅을 실시.